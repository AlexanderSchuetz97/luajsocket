--This file is part of luasocket Copyright © 2004-2013 Diego Nehab
--For more information on lua socket see https://github.com/diegonehab/luasocket/
--This file was copied over to luajsocket as permitted by the LuaSocket 3.0 licence
--This file is licensed under the LuaSocket 3.0 license.
--A copy of the LuaSocket 3.0 license can be found in this folder or on
